...
const Login = () => {
    ...
    //             <button type="submit" className="transition duration-200 bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50 rounded-lg text-white px-6 py-3 text-sm mt-5 w-full">Login</button>
    //           </form>
    //         </div>
    //       </div>
    //     </div>
      ...
      <div className="backdrop-blur-sm bg-white/30 shadow-lg w-full rounded-lg divide-y divide-gray-200">
        <div className="px-5 py-7">
          <form>
            ...
            <button type="submit" className="transition duration-200 bg-blue-600 hover:bg-blue-700 focus:bg-blue-800 focus:shadow-sm focus:ring-4 focus:ring-blue-400 focus:ring-opacity-50 rounded-lg text-white px-6 py-3 text-sm mt-5 w-full">Login</button>
          </form>
        </div>
      </div>
    </div>
